...
f_table_new = result_table 
f_table2 =f_table_new
#colnames(f_table_new)
#
colnames(f_table2)=c ("AA_id","AB_group","H_speeds","N_distance_traveled","M_#walks","D_turning_angle","E_meander", 
                       "O_activitytime_ST",
                     "K_act_bouts_ST","C_pause_length_ST","I_#pauses_ST","P_activitytime_timeT",
                     "L_act_bouts_DtimeT","B_pause_length_timeT","J_#pauses_timeT", "F_thigmotaxis_moving", "G_thigmotasix_pause","AC_stripe_deviation")
